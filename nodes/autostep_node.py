...
class AutostepNode(object):
    ...
    def __init__(self,port='/dev/ttyACM0'):
        ...
        self.command_srv_table = {
                ...
                'get_position'          : self.on_get_position,
    ...
    def on_get_position(self,args_dict):
    ...
    def on_sinusoid_command(self,args_dict):
        ...
        if ok:
            ...
            motion_thread = threading.Thread(target=self.autostep.sinusoid,args=[param,motion_data_callback])
            motion_thread.start()
